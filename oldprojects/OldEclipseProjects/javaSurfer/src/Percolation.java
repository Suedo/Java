...
public class Percolation {
	...
	public boolean isFull(int row , int col){ // is the site full ?
		 ...
		 *  because i had logically connected the top row to the virtual top ,
		 *  and the above code , since it only checked for connection and not if the site was OPEN or not ,
		 *  it made my code completely wrong!
...
//				++opensites;
//				String op = String.format("%2d. opening : %d,%d",count,row,col);
...
//				}
//			}else{
//				String op = String.format("%2d. site %d,%d is open",count,row,col);
//				System.out.println(op);
//			}			
//		}
//	}
